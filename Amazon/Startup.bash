...
instance_id=$(aws ec2 run-instances --image-id ami-a9ce15c9 --security-group-ids sg-923a98f6 --count 1 ----block-device-mappings "[{\"DeviceName\": \"/dev/sdh\",\"Ebs\":{\"VolumeSize\":100}}]" --instance-type r4.4xlarge --key-name rstudio --instance-initiated-shutdown-behavior stop --query 'Instances[0].{d:InstanceId}' --output text --iam-instance-profile Name="Ben")
