...
ggplot(mr,aes(col=bstate,y=mean,ymin=lower,ymax=upper,x=Behavior)) + geom_pointrange(size=1.5,position = position_jitter(width = .3)) + theme_bw() + ggtitle("Average Duration of Behavior") + labs(y="Hours")
