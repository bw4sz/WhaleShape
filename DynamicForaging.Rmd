...
#paramters to track
pt<-c("theta","gamma","phi","alpha","alpha_mu","alpha_tau","gamma_mu","gamma_tau","state")

if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=100000,n.burnin=95000,n.thin=5,DIC=FALSE))
}
