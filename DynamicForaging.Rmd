...
#paramters to track
pt<-c("theta","gamma","phi","alpha","alpha_mu","alpha_tau","state")

if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=200000,n.burnin=195000,n.thin=2,DIC=FALSE))
}
