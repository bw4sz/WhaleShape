...
mxy$argos.lc<-factor(mxy$argos.lc,levels=c(3,2,1,0,"A"))
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=70000,n.burnin=67000,n.thin=8,DIC=FALSE))
}
